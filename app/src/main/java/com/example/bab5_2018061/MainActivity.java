package com.example.bab5_2018061;
...
import com.example.bab5_2018061.databinding.ActivityMainBinding;
import com.example.bab5_2018061.databinding.ActivityMainBinding;
import com.example.bab5_2018061.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    String s1[], s2[], s3[];
    int images[] =
            {R.drawable.dawet_putih, R.drawable.dawet_ireng, R.drawable.dawet_grandul_ketan};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1 = getResources().getStringArray(R.array.Dawet);
        s2 = getResources().getStringArray(R.array.deskripsi);
        s3 = getResources().getStringArray(R.array.star);
        DawetAdapter appAdapter = new DawetAdapter(this, s1, s2, s3, images);
